#!/usr/bin/env bash
export REVISION=`git rev-list master --count`
...
sudo apt-get install build-essential cmake gcc libgeoip-dev libzip-dev make subversion sqlite3 libmysql++ apache2 php5-mysql libapache2-mod-php5 liblua5.1-socket mysql-server libssl-dev libboost1.53-all
