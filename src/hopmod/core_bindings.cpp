...
void bind_core_functions(lua_State * L, int T)
{
    ...
    bind_function(L, T, "set_invisible_root", server::set_player_private_root);
...
//  bind_var(L, T, "botname", server::aiman::botname);
    ...
    bind_var(L, T, "allow_mastermode_open", server::allow_mm_open);
    ...
    bind_var(L, T, "cginsta", server::cginsta);
    bind_var(L, T, "sginsta", server::sginsta);
    bind_var(L, T, "rlinsta", server::rlinsta);
    bind_var(L, T, "glinsta", server::glinsta);
    bind_var(L, T, "instaammo", server::instaammo);
    bind_var(L, T, "instahp", server::instahp);
